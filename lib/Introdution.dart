...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    const pageDecoration = const PageDecoration(
      ...
      bodyPadding: EdgeInsets.fromLTRB(16.0, 0.0, 16.0, 22.0),
    ...
    return IntroductionScreen(
      ...
      globalHeader: Align(
        ...
        child: SafeArea(
          child: Padding(
            ...
            // child: _buildImage('atclogo.jpg', 100),
          ),
        ),
      ),
      ...
      pages: [
        ...
        PageViewModel(
          title: "Pesquisas Rápidas",
          body:
          "O app tem como objetivo facilitar a mobilidade sobre as consultas das informações no sitema ATC.",
          image: _buildImage('Lupa.png'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Desenvolvimento",
          body:
          "Novas funcionalidades, aprimoramento do aplicativo sempre em busca da solução.",
