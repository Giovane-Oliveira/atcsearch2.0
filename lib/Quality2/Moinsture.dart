                                  ...
                                  (index) {
                                    ...
                                    if (emp.sampledate.toString() != "null") {
                                      ...
                                      emp.shift = 0;
                                        ...
                                        "null") {
                                      emp.sampletime = "0";
                                    } else if (emp.brabender.toString() ==
                                        "null") {
                                      emp.brabender = 0;
                                    } else if (emp.oven.toString() == "null") {
                                      emp.oven = 0;
                                    } else if (emp.coolerr.toString() ==
                                        "null") {
                                      emp.coolerr = 0;
                                    } else if (emp.coolerl.toString() ==
                                        "null") {
                                      emp.coolerl = "0";
                                    } else if (emp.blending.toString() ==
                                        "null") {
                                      emp.blending = "0";
                                    } else if (emp.bthresh.toString() ==
                                        "null") {
                                      emp.bthresh = 0;
