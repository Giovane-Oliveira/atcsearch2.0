                            ...
                            rows: List.generate(
                              ...
                              (index) {
                                ...
                                if (emp.ps4.toString() == "null") {
                                  ...
                                  emp.fiberspan = "0";
                                } else if (emp.totalstems.toString() ==
                                    "null") {
                                  emp.totalstems = "0";
                                }
                                return DataRow(
                                ...
                                Text(emp.cod_grade.toString()),
                                      ...
                                      DataCell(
                                        Text(
                                            double.parse(emp.d1x1.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.d12x12.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.total12.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.d14x14.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.total14.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.d18x18.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.pan.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.s332.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.s7.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.s12.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                      ...
                                      DataCell(
                                        Text(
                                            double.parse(
                                                    emp.totalstems.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ),
                                      DataCell(
                                        Text(
                                            double.parse(emp.ps4.toString())
                                                .toStringAsFixed(2),
                                            textAlign: TextAlign.center),
                                      ), /*DataCell(
